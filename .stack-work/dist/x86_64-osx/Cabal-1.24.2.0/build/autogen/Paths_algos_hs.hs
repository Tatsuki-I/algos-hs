...
sysconfdir = "/Users/tatsuki/GitHub/algos-hs/.stack-work/install/x86_64-osx/lts-8.22/8.0.2/etc"

getBinDir, getLibDir, getDynLibDir, getDataDir, getLibexecDir, getSysconfDir :: IO FilePath
getBinDir = catchIO (getEnv "algos_hs_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "algos_hs_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "algos_hs_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "algos_hs_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "algos_hs_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "algos_hs_sysconfdir") (\_ -> return sysconfdir)
